...

{
  ...
  #make is celsius vector
  isCelsius = grep(pattern = "[cC]", x=classData2$temp);
  #Make the whole column Fahrenheit, then change spefcific to Celsius
  classData2$tempType = "Fahrenheit"; classData2$tempType[isCelsius] = "Celsius";
  #create a vector with just numeric characters for temp
